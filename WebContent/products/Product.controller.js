...
*/
	onInit: function() {
		...
		var oModel = new sap.ui.model.odata.ODataModel("proxy/http/services.odata.org/V3/(S(qp3dv2yjniu5rres2azjgwfk))/OData/OData.svc")
...
//	},
	...
	save: function(){
		...
		if(this.mode == 'create'){
			var url = "proxy/http/services.odata.org/V3/(S(qp3dv2yjniu5rres2azjgwfk))/OData/OData.svc/Products";
			var method = "POST";
			...
			var id = $("#id").val();
			var url = "proxy/http/services.odata.org/V3/(S(qp3dv2yjniu5rres2azjgwfk))/OData/OData.svc/Products("+id+")";
			var method = "PUT";
